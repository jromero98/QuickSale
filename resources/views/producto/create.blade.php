	...
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<div class="form-group">
				...
				<input type="number" required value="{{old('precio')}}" name="precio" class="form-control" placeholder="Precio...">
			</div>
		</div>
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<div class="form-group">
				<label for="descripcion">Descripcion</label>
				<textarea name="descripcion" class="form-control" cols="30" rows="5" placeholder="Descripcion..."></textarea>
			</div>
		</div>
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<div class="form-group">
				...
				<input type="number" required value="{{old('cantidad')}}" name="cantidad" class="form-control" placeholder="Cantidad...">
			</div>
		</div>
	</div>
			<div class="form-group">
